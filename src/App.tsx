...
const GOOGLE_SCRIPT_URL =
  'https://script.google.com/macros/s/AKfycbzE1Ne8LwD0cWwTkBpMHo55P6rRznWdr19SACqsvTg_JE93rNqTgKrw_wAmiUZ61SEc/exec';
...
export default function App() {
  ...
  const openRegister = useCallback((courseName = '') => {
    ...
    // Facebook Pixel: InitiateCheckout when opening register form
    trackFBEvent('InitiateCheckout', {
      content_name: courseName || 'Đăng ký chung',
    });
  }, []);
  ...
  const openPayment = useCallback((courseName: string, price: number, code: string) => {
    ...
    setShowPayment(true);
    // Facebook Pixel: Purchase event when opening payment page
      ...
      <div className="site-wrap">
            ...
            <div className="courses-grid">
              {COURSES.map((c, idx) => (
                <article
                  ...
                  onClick={() => { setActiveCourse(c); trackFBEvent('ViewContent', { content_name: c.title, content_ids: String(c.id), content_type: 'product', value: parseInt(c.salePrice), currency: 'VND' }); }}
        ...
        <section className="contact-section" id="contact">
          <div className="contact-inner">
            <a href="https://zalo.me/0396581283" target="_blank" rel="noopener noreferrer" className="zalo-block" id="zalo-contact-link" onClick={() => trackFBEvent('Contact', { content_name: 'Zalo Tư Vấn' })}>
